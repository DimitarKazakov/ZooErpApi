...
namespace ZooErp.Controllers
{
	public class EventController: ApiControllerBase
	{
        ...
        [HttpGet("[action]")]
        [Authorize]
        public async Task<IEnumerable<EventDto>> GetAllAsync([FromQuery] FilterDto filter)
        ...
        [HttpPut("[action]/{id}")]
        [Authorize(Policy = "Administrator")]
        public async Task<bool> UpdateAsync([FromRoute] int id, [FromBody] CreateEventDto data, [FromHeader] string authorization)
            => await this.service.UpdateAsync(data, id, authorization);

        [HttpPost("[action]")]
        [Authorize(Policy = "Administrator")]
        public async Task<bool> CreateAsync([FromBody] CreateEventDto data, [FromHeader] string authorization)
